...
Film f6("Inception", "Action, Adventure, Thriller", 2010, 5, "https://www.youtube.com/watch?v=YoHD9XEInc0");
Film f7("Joker", "Crime, Drama, Thriller", 2019, 9, "https://www.youtube.com/watch?v=rgXplohCw5o");
Film f8("Avengers: Endgame", "Action, Adventure, Drama", 2019, 15, "https://www.youtube.com/watch?v=TcMBFSGVi1c");
Film f9("The Wolf of Wall Street", "Biography, Crime, Drama", 2013, 7, "https://www.youtube.com/watch?v=iszwuX1AK6A");
Film f10("Suicide Squad", "Action, Adventure, Fantasy", 2016, 9, "https://www.youtube.com/watch?v=CmRih_VtVAs");
...
//    assert(f6.getLikes() == 2);
    ...
    assert(user.getFilmRepo().getLikes(f1) == 76190);
    user.like(f1);
    cout << (user.getFilmRepo().getLikes(f1));
    assert(user.getFilmRepo().getLikes(f1) == 76191);
}